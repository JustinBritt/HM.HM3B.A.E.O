namespace HM.HM3B.A.E.O.Factories.Calculations.ScenarioRequiredNumberBeds
{
    ...
    internal sealed class tStarCalculationFactory : ItStarCalculationFactory
    {
        private ILog Log => LogManager.GetLogger(System.Reflection.MethodBase.GetCurrentMethod().DeclaringType);

        public tStarCalculationFactory()
        {
        }

        public ItStarCalculation Create()
        {
            ItStarCalculation calculation = null;

            try
            {
                calculation = new tStarCalculation();
            }
